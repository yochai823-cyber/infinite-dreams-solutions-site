    ...
    <section id="contact" className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed whitespace-pre-line md:whitespace-normal">
            {d.contactSub}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a 
              ...
              className="group bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-3 px-6 rounded-full text-base transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center gap-2"
            >
              ...
              <span className="force-ltr text-sm">{d.phone}</span>
            </a>
            
            <a 
              href={`mailto:${d.email}`} 
              className="group bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white font-semibold py-3 px-6 rounded-full text-base transition-all duration-300 hover:bg-white/20 hover:border-white/50 flex items-center gap-2"
            >
